...
import example.{Guitar, GuitarDB, GuitarStoreJSONProtocol}
...
object HighLevelGuitar extends App with GuitarStoreJSONProtocol {
...
//            val guitarFuture: Future[List[Guitar]] = (guitarDb ? FindAllGuitarInStock(inStock)).mapTo[List[Guitar]]
